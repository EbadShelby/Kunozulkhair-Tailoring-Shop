...
function loadProfileData() {
  ...
  document.getElementById('profile-role').textContent = 'Senior Tailor';
  document.getElementById('profile-email').textContent = 'sarah@kunozulkhair.com';
  
  // Update profile details
  document.getElementById('full-name').textContent = 'Sarah Johnson';
  document.getElementById('email').textContent = 'sarah@kunozulkhair.com';
  document.getElementById('phone').textContent = '+63 923 456 7890';
  document.getElementById('role').textContent = 'Senior Tailor';
  document.getElementById('specialization').textContent = 'Wedding Dresses, Formal Wear';
  document.getElementById('experience').textContent = '8 years';
  document.getElementById('username').textContent = 'sarahj';
  document.getElementById('last-login').textContent = 'Today at 8:45 AM';
  document.getElementById('account-created').textContent = 'March 15, 2023';
  
  // Update sidebar user info
  document.getElementById('user-name').textContent = 'Sarah Johnson';
  document.getElementById('user-role').textContent = 'Senior Tailor';
  
  // Update dropdown user name
  document.getElementById('dropdown-user-name').textContent = 'Sarah';
}

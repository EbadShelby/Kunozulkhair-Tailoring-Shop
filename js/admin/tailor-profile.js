...
function loadProfileData() {
  ...
  document.getElementById('profile-name').textContent = 'Ryan Mentang';
  document.getElementById('profile-role').textContent = 'Tailor';
  document.getElementById('profile-email').textContent = 'ryan.mentang@example.com';

  // Update profile details
  document.getElementById('full-name').textContent = 'Ryan Mentang';
  document.getElementById('email').textContent = 'ryan.mentang@example.com';
  document.getElementById('phone').textContent = '+63 912 345 6789';
  document.getElementById('username').textContent = 'ryanm';
  document.getElementById('last-login').textContent = 'Today at 9:15 AM';
  document.getElementById('account-created').textContent = 'January 15, 2022';

  // Update sidebar user info
  document.getElementById('user-name').textContent = 'Ryan Mentang';
  document.getElementById('user-role').textContent = 'Tailor';

  // Update dropdown user name
  document.getElementById('dropdown-user-name').textContent = 'Ryan';
}

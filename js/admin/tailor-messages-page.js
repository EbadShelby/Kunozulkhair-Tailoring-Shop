...
function renderTailorMessagesPage() {
  const container = document.getElementById('tailor-messages-list');
  if (!container) return;
...
function filterMessages() {
  ...
  let filteredMessages = [...tailorMessages];
